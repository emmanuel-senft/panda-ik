...
extern "C" {
    ...
    void solveDroneOnly(double* robot_state, double* drone_current, double* drone_goal, double* last_drone_goal, bool* errors, const double* plane_normals, const double* plane_points, const double* plane_centers, const double* plane_orientations, const double* plane_half_axes, const uint8_t* plane_number);
}